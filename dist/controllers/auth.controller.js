...
exports.logout = exports.googleAuth = exports.signin = exports.verifyEmail = exports.signup = void 0;
...
const signin = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const isPasswordValid = yield bcrypt_1.default.compare(password, 
        // @ts-ignore
        user.password);
        if (!isPasswordValid) {
            return res.status(401).json({ message: "Invalid credentials" });
